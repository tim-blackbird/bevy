use crate::{CalculatedClip, DefaultUiCamera, Node, ResolvedBorderRadius, TargetCamera, UiScale};
use bevy::input::{mouse::MouseButton, touch::Touches, ButtonInput};
use bevy::math::{Rect, Vec2};
use bevy::reflect::{std_traits::ReflectDefault, Reflect};
use bevy::render::{camera::NormalizedRenderTarget, prelude::Camera, view::ViewVisibility};
